...
<?php
	...
	echo $this->Form->button('Add Publisher',
	array('onclick' => "location.href='".$this->Html->url($urlAdd)."'"));
?>
<table>
	<tr>
		<th>ID</th>
	...
	<td>
	<?php echo $this->Html->link("Details",array("controller"=> "publishers",
	"action"=>"view", $publisher["Publisher"]["id"])); ?>
	</td>
	</tr>
	<?php
	}
